...
export default function AddFoodCollectingDetails() {
  ...
  async function handleSubmit(e) {
    ...
    if (
      ...
      axios
        .post('http://localhost:5000/api/foodCollection/', FoodCollectData)
    ...
    <>
      ...
      <div className="d-flex justify-content-center">
        ...
        >
          ...
          >
            <h1 className="card-title text-light">Add Food Collect Details</h1>
            <br />
            <br />
            <div className="d-flex justify-content-center">
